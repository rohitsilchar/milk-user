          ...
          children: [
            ...
            Container(
              decoration: BoxDecoration(
               color:dark(context) ? Colors.grey.shade700 : Colors.transparent,
                 ...
                 'Select Language',
                  ...
                  child: GridView(
                    gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                      crossAxisCount: setting.value.languages!.length <= 2 ? 1 : 2,
                      mainAxisSpacing: 12,
                      crossAxisSpacing: 16,
                      childAspectRatio:  setting.value.languages!.length <= 2 ? 60/12 :  21/9
                      ),
                    ...
                    ...setting.value.languages!.asMap().entries.map((e) {
                          ...
                          return selectLanguageButton(
                                  ...
                                  onPress: () async {
                                    ...
                                    get.write("language", e.value.languageCode.toString());

                                    appState.currentLanguageCode.value =e.value.languageCode!;
                                    setState(() { });
                                    BotToast.showLoading();
                                   
                                        await settingRepo.getKeysLists(
                                            appState.currentLanguageCode.value).then((value) {
