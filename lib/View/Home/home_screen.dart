          ...
          children: [
                        ...
                        children: [
                          GestureDetector(
                              ...
                              child: Stack(
                                ...
                                children: [
                                  SvgPicture.asset(
                                    ...
                                    colorFilter: ColorFilter.mode( MyColor.bottomNavBar as Color, BlendMode.srcATop), //commonColorSet1
                                  ),
                                  Positioned(
                                    top: 2,
                                    right: 3,
                                    child: ValueListenableBuilder<int>(
                                        ...
                                        builder: (context, _notificationCount,
                                            child) {
                           ...
                           onTap: () {
                            ...
                            child: Container(
                              height: 40,
                          decoration: BoxDecoration(
                          color: dark(context) ?  MyColor.coreBackgroundColor : MyColor.white,
                          border: Border.all(width: 1,color: dark(context) ? Colors.white30 : Colors.grey.shade300),
                          borderRadius: BorderRadius.circular(100)
                              ...
                              children: [
                                Padding(
                                  ...
                                  color: dark(context) ? Colors.grey.shade300 :Colors.grey.shade400),
                                ),
                                SizedBox(width: 6),
                                Text(UtilsHelper.getString(context, 'search'),
                                style: TextStyle(
                                  fontSize: 14,
                          ...
                          GestureDetector(
                            ...
                            child: SvgPicture.asset(
                              "assets/settings.svg",
                              colorFilter: ColorFilter.mode(MyColor.bottomNavBar as Color, BlendMode.srcIn), //commonColorSet1
                            ),
                          ),
                        ],
                      ),
             ...
             Expanded(
               child: RefreshIndicator(
                  ...
                  if(load == 0 && scrollInfo.metrics.pixels >= (scrollInfo.metrics.maxScrollExtent * 0.5) && products!.nextPageUrl != null){
                      load++;
                      setState(() { });
                  }
                  if(load == 1  && scrollInfo.metrics.pixels >= (scrollInfo.metrics.maxScrollExtent * 0.5) &&  products!.nextPageUrl != null) {
                    // Future.delayed(Duration(seconds: 2),() {
                      load++;
                      setState(() { });

                       con.getPaginatedProducts(products!.nextPageUrl ?? "").whenComplete((){
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color: index == _currentIndex
                                            ...
                                            :  dark(context) ?Colors.white60 : MyColor.commonColorSet1, //commonColorSet1
                        ...
                        children: [
                          Text(
                            ...
                            style: Theme.of(context).textTheme.displaySmall?.copyWith(
                                  ...
                                  fontSize: 18,
                                  color: dark(context) ? Colors.white :MyColor.commonColorSet1, //commonColorSet1
                                  fontWeight: FontWeight.w400,
                             ),
                          ),
                        ],
