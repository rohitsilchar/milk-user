          ...
          //     ],
                         ...
                         style: Theme.of(context)
                             ...
                             ?.copyWith(
                               fontFamily: !UtilsHelper.rightHandLang
                                   ...
                                   : UtilsHelper.the_sans_font_family,
                               fontSize: 16,
                               height: !UtilsHelper.rightHandLang
                                       .contains(lang)
                                   ?  1.3: 1,
                              ...
                              //  width: size.width * 0.84 - 120,
                               ...
                               child: TextFormField(
                                 ...
                                 decoration: InputDecoration(
                                  counterText: '',
                                   hintText: UtilsHelper.getString(context, 'phone_number'),
                                   // prefixText:  ',
                                   ...
                                   contentPadding:
                                       EdgeInsets.only(left: 0,right: 22,top: 10,bottom: 6),
                                   hintStyle: TextStyle(
                                 ...
                                 style: TextStyle(
                                     fontSize: 16, color:dark(context) ?Colors.white :  MyColor.black),
                               ),
                             ),
                           ),
                         ],
           ...
           textStyle:
               Theme.of(context).textTheme.bodyLarge?.copyWith(
                     ...
                     fontSize: 16,
                     fontWeight: !UtilsHelper.rightHandLang.contains(lang)
                             ? FontWeight.w700
                             : FontWeight.w400,
                   ),
