    ...
    timer = Timer.periodic(Duration(seconds: 1),(timer) { 
        // WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
          if (sec == 1) {
           ...
           Navigator.of(context).pushNamedAndRemoveUntil(RoutePath.home_screen,(route) => false);
        } else {
             setState(() { 
              sec -= 1;
           });
            ...
            children: [
              ...
              Text(
                ...
                style: Theme.of(context).textTheme.displayMedium?.copyWith(
                      fontFamily: !UtilsHelper.rightHandLang.contains(lang) ? 'Helvatica': 'TheSans',
                      color:Colors.black,
              ...
              SizedBox(height: 15),
              Text("${UtilsHelper.getString(context, 'redirecting_in')} ${sec.toString()} seconds",
              style: TextStyle(
